...
This simulates a real-world identity lifecycle workflow used for onboarding and access governance.
...
02-new-user-form.png  
03-user-created.png  
04-new-group-form.png  
05-group-members.png  
06a-cli-users.png  
06b-cli-group-members.png  
```
